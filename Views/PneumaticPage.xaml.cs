...
{
    public partial class PneumaticPage : ContentPage
    {
        private bool _isLoaded = false;

        public PneumaticPage()
        {
            InitializeComponent();
        }
        ...
        private async Task LoadPosterAsync()
        {
            try
            {
                using var stream = await FileSystem.Current.OpenAppPackageFileAsync("poster_pneumatica.png");
        ...
        private void OnWebViewHandlerChanged(object sender, EventArgs e)
        {
            ...
            if (webView != null)
            {
                ...
                // Senza i vincoli CSS, questi due parametri prendono il pieno controllo
                // scalando l'immagine grande per farla entrare nello schermo e abilitando lo zoom
